...
net = jetson.inference.imageNet('alexnet',['--model=/home/jetson/Downloads/jetson-inference/python/training/classification/myModelDolls32Ep/resnet18.onnx','--input_blob=input_0','--output_blob=output_0','--labels=/home/jetson/Downloads/jetson-inference/myTrainDolls/labels.txt'])

font = cv2.FONT_ITALIC

timeMark = time.time()
fpsFilter = 0
outVid = cv2.VideoWriter('videos/modelDolls32Ep.avi',cv2.VideoWriter_fourcc(*'XVID'),5,(960,540))
